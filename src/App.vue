  ...
  <div id="app">
    <form @submit.prevent="validateBeforeSubmit" v-if="!formSubmitted">
        ...
        <div class="form-group" :class="{'has-error': errors.has('name') }">
            ...
            <input v-model="name" v-validate.initial="name" data-rules="required|alpha|min:4|max:8" class="form-control" type="text" placeholder="Full Name">
...
VeeValidate.Validator.extend('passphrase', {
    ...
    validate: value => value.toUpperCase() == 'Prajkta'.toUpperCase()
});
